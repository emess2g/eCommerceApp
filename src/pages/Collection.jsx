...
import ProductItem from '../components/context/ProductItem';
const Collection = () => {
    ...
    <div className=' flex flex-col sm:flex-row gap-1 sm:gap-10 pt-10 border-t'>
      ...
      <div className="min-w-60">
        <p onClick={()=>setShowFilter(!showFilter)} className='my-2 text-xl flex items-center cursor-pointer gap-2'>FILTERS
          <img className={`h-3 sm:hidden ${showFilter ? ' duration-300 rotate-90' : 'duration-300'}`} src={assets.dropdown_icon} alt="" />
        </p>
        {/* category filter */}
        <div className={`border border-gray-300 pl-5 py-3 mt-6 ${showFilter ? '' : 'hidden'} sm:block`}>
          ...
          <div className="flex flex-col gap-2 text-sm font-light text-gray-700">
            ...
            <p className='flex gap-2'>
              <input className='w-3' type="checkbox" onChange={toggleCategory} value={'Women'}/>Woman
            </p>
            <p className='flex gap-2'>
